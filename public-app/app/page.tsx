...
export default async function Home() {
  ...
  firs.forEach((f: any) => {
    if (f.police_stations) stationsMap.set(f.police_stations.id, f.police_stations);
    ...
    <PublicPortalShell>
      ...
      <div className="mb-8">
        ...
        <p className="mt-4 text-lg text-slate-600 max-w-3xl">
          ...
          district. Use the filters below to find specific incidents or track case statuses.
        </p>
      </div>
      ...
      {/* Statistics Charts */}
      <div className="mb-10 rounded-2xl bg-white shadow-sm border border-slate-200/60 overflow-hidden p-6">
        <h3 className="text-lg font-semibold text-slate-900 mb-6">Crime Analytics</h3>
